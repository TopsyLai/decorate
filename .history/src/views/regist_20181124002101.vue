<template>
    <div class="regist">
        <group>
            <x-input title="" name="phone" placeholder="请输入手机号" v-model="phone" keyboard="number" is-type="china-mobile" required></x-input>
            <x-input title="">
              <img slot="right-full-height" :src="'/api/'+getCode.img" />
            </x-input>
            <x-input title="" type="text" placeholder="请输入验证码" v-model="mobileCode	" required>
